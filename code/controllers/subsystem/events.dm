SUBSYSTEM_DEF(events)
	...
	var/frequency_lower = 2 MINUTES	//1 minutes lower bound.
	var/frequency_upper = 4 MINUTES	//3 minutes upper bound. Basically an event will happen every 1 to 3 minutes.
