SUBSYSTEM_DEF(events)
	...
	var/frequency_lower = 1 MINUTES	//1 minutes lower bound.
	var/frequency_upper = 3 MINUTES	//3 minutes upper bound. Basically an event will happen every 1 to 3 minutes.
